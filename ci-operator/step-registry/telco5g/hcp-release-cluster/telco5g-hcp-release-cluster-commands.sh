...
# Install required collections and modules, include it in CI image later
ansible-galaxy collection install community.kubernetes
pip install -U jmespath

status=0
ANSIBLE_LOG_PATH=$ARTIFACT_DIR/ansible.log ANSIBLE_STDOUT_CALLBACK=debug ansible-playbook -vv \
